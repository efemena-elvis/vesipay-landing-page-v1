      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 relative overflow-hidden">
            ...
            <div className="absolute -bottom-10 -right-10 w-32 h-32 opacity-10">
              <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="fill-vesipay-600">
        ...
        <div className="mt-20 flex justify-center animate-fade-in">
          <svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-3xl">
            ...
            {/* Globe */}
            <ellipse cx="400" cy="200" rx="200" ry="200" fill="url(#globeGradient)" opacity="0.3" />
            ...
            {/* Connection paths */}
            <g stroke="url(#pathGradient)" strokeWidth="2" fill="none" strokeDasharray="5,5">
