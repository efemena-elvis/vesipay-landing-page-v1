  ...
  const steps = [
    {
      ...
      title: "Sign Up",
      description:
        "Create your Vesipay account and complete the verification process.",
    },
    {
      number: "02",
      title: "Connect Your Systems",
      description:
        "Integrate Vesipay with your existing business systems using our API or dashboard.",
    },
    {
      number: "03",
      title: "Configure Payment Options",
      description:
        "Set up your preferred payment methods and currencies for your business.",
    },
    {
      number: "04",
      title: "Start Transacting Globally",
      description:
        "Begin accepting and sending payments worldwide with competitive rates.",
    },
  ];
